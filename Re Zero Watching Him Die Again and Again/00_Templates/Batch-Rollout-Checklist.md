...
Use this checklist for every bounded Re:Zero fanfiction batch run. Fill in the placeholders before execution.
...
- [ ] Confirm no provider/meta text or unintended source-English prose remains.
