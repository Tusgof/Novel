...
1. Compare HGD, DSE, and IRS OOS evidence and produce the V6.34 M6 production recommendation; do not publish experiment outputs.
...
3. Track that IRS OOS did not repeat CJK/Hanja parenthetical leakage or the `Complete Memory` minor miss, but did repeat OpenRouter empty-assistant smoothness risk.
