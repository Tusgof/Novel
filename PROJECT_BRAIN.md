...
1. Immortality System: the mandatory Libra - Pilot Gate is complete in experiment-only output. Obtain a separate explicit production chapter range, then start a fresh scan-only/glossary gate; do not promote pilot artifacts automatically.
