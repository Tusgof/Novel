...
1. Resume DSE OOS v2 from `ch047` in `Deep Sea Embers/04_Work/_experiments/v6_34_m6_dse_oos_v2`; stop and record if a QA hard-fail, provider failure, validation failure, source mismatch, or Sentinel blocker/major appears.
