...
1. Rebuild a fresh DSE OOS experiment vault from current production raw/title sidecars, run `scripts/verify_experiment_source_parity.py` from repo root for the exact locked DSE OOS chapters, and require `0` mismatches before any provider calls.
