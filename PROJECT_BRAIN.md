...
1. Run IRS OOS in its isolated experiment vault after verifying source parity and title sidecar readiness; stop and record if a QA hard-fail, provider failure, validation failure, source mismatch, or Sentinel blocker/major appears.
