    ...
    .map((novel) => {
      ...
      return {
        ...
        novel: {
          ...
          synopsisSourceUrl: reader.synopsis_source_url,
          synopsisSourceNote: reader.synopsis_source_note,
          tags: reader.tags || [],
          cover: reader.cover,
        },
      };
...
const library = {
  ...
  books: generated.map((entry) => ({
    ...
    synopsisSourceUrl: entry.manifest.novel.synopsisSourceUrl,
    synopsisSourceNote: entry.manifest.novel.synopsisSourceNote,
