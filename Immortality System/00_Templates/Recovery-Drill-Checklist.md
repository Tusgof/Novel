...
```powershell
git status -sb
novel-pipeline --config "Immortality System/.system/config.yaml" preflight
novel-pipeline --config "Immortality System/.system/config.yaml" report recovery-drill
```
...
novel-pipeline --config "Immortality System/.system/config.yaml" report preflight
novel-pipeline --config "Immortality System/.system/config.yaml" report recovery-drill
```
...
```powershell
novel-pipeline --config "Immortality System/.system/config.yaml" status --run-id <run_id>
```
...
```powershell
git restore --source=HEAD --worktree -- PROJECT_BRAIN.md IMPLEMENT_PLAN.md AGENTS.md ARCHITECTURE.md
```
...
```powershell
python -m compileall "Deep Sea Embers/novel_pipeline"
python "Deep Sea Embers/test_translation.py"
novel-pipeline --config "Immortality System/.system/config.yaml" preflight
novel-pipeline --config "Immortality System/.system/config.yaml" report product-review --run-id <run_id>
```
...
```powershell
git add PROJECT_BRAIN.md IMPLEMENT_PLAN.md AGENTS.md ARCHITECTURE.md
