...
- Current operator window scope:
  ...
  - glossary suggestion loading with 2-3 Thai options plus a custom Thai term field
...
- V6.6 complete:
  ...
  - glossary scan is AI-assisted through configured term extraction with a bounded per-scan call budget
...
- V6.7 complete:
  ...
  - glossary approval can use a provider-suggested Thai option or a manually typed custom Thai term
