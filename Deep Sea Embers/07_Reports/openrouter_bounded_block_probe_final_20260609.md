# OpenRouter Bounded Block Probe - openrouter_bounded_block_probe_20260609_033555_rescored

## Summary

| Role | Route | Provider | Model | Score | Hard fail | Duration | Failure |
| --- | --- | --- | --- | ---: | --- | ---: | --- |
| glossary | openrouter_gemini3_flash | openrouter | `google/gemini-3-flash-preview` | 100 | False | 6.85s | none |
| glossary | current_gemini_pro | gemini | `pro` | 60 | True | 75.92s | quota |
| literal | openrouter_gemini3_flash | openrouter | `google/gemini-3-flash-preview` | 100 | False | 5.18s | none |
| literal | openrouter_deepseek_v4_flash | openrouter | `deepseek/deepseek-v4-flash` | 100 | False | 20.60s | none |
...
| qa | current_qwen_deepseek_reasoner | qwen | `deepseek-reasoner` | 100 | False | 39.27s | none |
| qa | openrouter_gemini3_flash | openrouter | `google/gemini-3-flash-preview` | 100 | False | 1.94s | none |
| qa | openrouter_deepseek_v4_pro | openrouter | `deepseek/deepseek-v4-pro` | 100 | False | 26.08s | none |
...
- `glossary`: first candidate `openrouter_gemini3_flash` (`google/gemini-3-flash-preview`), score 100, hard_fail=False.
- `literal`: first candidate `openrouter_gemini3_flash` (`google/gemini-3-flash-preview`), score 100, hard_fail=False.
- `refine`: first candidate `openrouter_gemini3_flash` (`google/gemini-3-flash-preview`), score 100, hard_fail=False.
- `qa`: first candidate `openrouter_gemini3_flash` (`google/gemini-3-flash-preview`), score 100, hard_fail=False.
